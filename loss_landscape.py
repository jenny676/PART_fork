...
# ---------------- USER CONFIG ----------------
CHECKPOINT_PATH = "/content/drive/MyDrive/TDL/PART/PART_10%/latest.pth"   # change if your checkpoint is elsewhere
FIXED_BATCH_PATH = "/mnt/data/fixed_batch.pt"
SAVE_PATH = "/content/drive/MyDrive/TDL/PART/loss_landscape_resnet18.png"
